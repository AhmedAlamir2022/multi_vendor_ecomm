            ...
            <div class="cl-xl-12">
                @if ($homepage_secion_banner_four->banner_one->status == 1)
                    <div class="wsus__large_banner_content"
                        style="background: url({{ asset($homepage_secion_banner_four->banner_one->banner_image) }});">
                                ...
                                <div class="col-xl-6 col-12 col-md-6">
                                    <div class="wsus__large_banner_text">
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem repudiandae in
                                            ...
                                            nesciunt.</p>
                                        <a class="shop_btn"
                                            href="{{ $homepage_secion_banner_four->banner_one->banner_url }}">view
                                            more</a>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-12 col-md-6">
                                    <div class="wsus__large_banner_text wsus__large_banner_text_right">
                                        ...
                                        <a class="shop_btn"
                                            href="{{ $homepage_secion_banner_four->banner_one->banner_url }}">shop
                                            now</a>
                                    </div>
                                </div>
                            </div>
